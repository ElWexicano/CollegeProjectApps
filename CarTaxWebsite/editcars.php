...
<head>
<title>Update/Delete a Car Record</title>
...
<div id = "content">
<h2>Update/Delete a Car Record</h2>
<p>
<?php
...
<th>Registration</th><th>Year</th><th>Make</th><th>Engine Size</th><th>Taxed From</th><th>Taxed To</th><th>PPS</th><th>Tax Price</th></tr>';
 while ($row = mysql_fetch_array($result)) {
  ...
  echo '<td>' . "<a href='editcar2.php?Registration=$Registration'>Update</a>" . '</td>';
  echo '<td>' . "<a href='deletecar2.php?Registration=$Registration'>Delete</a>". '</td></tr>';
}
echo '</table>';
