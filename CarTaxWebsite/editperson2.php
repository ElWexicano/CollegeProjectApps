...
<form action = "editperson3.php" method = "post" id = "courseupdate" class="cartax">
    <fieldset>
    <legend>Please Complete the Details</legend>
        ...
        <div class ="fieldarea">
         ...
         <input type="text" name="Street" id="Street" size="20" value = "<?php echo $Street; ?>"/>
          </div>

        <div class ="fieldarea">
          <label for="Town" class="fixedwidth">Last Name</label>
         <input type="text" name="Town" id="Town" size="20" value = "<?php echo $Town; ?>"/>
          </div>

        <div class ="fieldarea">
          <label for="County" class="fixedwidth">Street</label>
         <input type="text" name="County" id="County" size="20" value = "<?php echo $County; ?>"/>
          </div>

        <div class ="fieldarea">
          <label for="Phone" class="fixedwidth">Phone</label></td>
          <input type="text" name="Phone" id="Phone" size="10" class = "numeric" value = "<?php echo $Phone; ?>"/>
        </div>
	...
	<div class="buttonarea">
    		<input type="submit" value="Update Personal Record" />
